...
class Userscontroller extends Controller
{
    ...
    {
        $this->layout = 'layout_alt.php'; // в этой ветке контроллера Лейаут будет альтернативным и своим :)
    }
    ...
    public function users_list()
    {
        ...
        if ((int) System::get_user()->role === NULL ) // любой авторизированный пользователь
        {
            header("Location: /auth/login");
            die();
        }
